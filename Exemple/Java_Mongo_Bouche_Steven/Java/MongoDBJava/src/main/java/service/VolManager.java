...
public class VolManager {
    ...
    /**
     Cette fonction permet d'ins�rer un vol dans une collection.
     */
    ...
    /**
     Cette fonction permet de tester la m�thode insertOneVol.
     */
    ...
    /**
     Cette fonction permet d'ins�rer plusieurs Vols dans une collection
     */
    ...
    /**
     Cette fonction permet de tester la fonction insertManyVols
     */
                ...
                Arrays.asList(
                        ...
                        new Document("_id",120)
                                ...
                                .append("appreciations",Arrays.asList(
                                        new Document("idClient",7)
                                                .append("notes",Arrays.asList(
                                                        new Document("apid",71)
                                                                .append("critereANoter","SiteWeb")
                                                                .append("note","BIEN"
                                                                ),
                                                        new Document("apid",72)
                                                                .append("critereANoter","Prix")
                                                                .append("note","BIEN"
                                                                ),
                                                        new Document("apid",73)
                                                                .append("critereANoter","Nourriture�bord")
                                                                .append("note","BIEN"
                                                                ),
                                                        new Document("apid",74)
                                                                .append("critereANoter","Qualit�si�ge")
                                                                .append("note","BIEN"
                                                                ),
                                                        new Document("apid",75)
                                                                .append("critereANoter","Accueilguichet")
                                                                .append("note","BIEN"
                                                                ),
                                                        new Document("apid",76)
                                                                .append("critereANoter","Accueil�bord")
                                                                .append("note","EXCELLENT"
                                                                )
                                                        )
                                        ...
                                        new Document("idClient",8)
                                                .append("notes",Arrays.asList(
                                                        new Document("apid",81)
                                                                .append("critereANoter","SiteWeb")
                                                                .append("note","PASSABLE"
                                                                ),
                                                        new Document("apid",82)
                                                                .append("critereANoter","Prix")
                                                                .append("note","BIEN"
                                                                ),
                                                        new Document("apid",83)
                                                                .append("critereANoter","Nourriture�bord")
                                                                .append("note","BIEN"
                                                                ),
                                                        new Document("apid",84)
                                                                .append("critereANoter","Qualit�si�ge")
                                                                .append("note","MOYEN"
                                                                ),
                                                        new Document(
    ...
    /**
     Cette fonction permet de rechercher un vol dans une collection
     connaissant son id.
     */

    public void getVolById(String nomCollection, Integer empId){
        //Drop a collection
        System.out.println("\n\n\n*********** dans getVolById *****************");
    ...
    /**
     Cette fonction permet de supprimer des vols dans une collection.
